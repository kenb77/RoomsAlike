# StayHaven — hourly space rental marketplace
...
- **Reviews** — once an approved booking's end time has passed, the renter can leave a 1–5 star
  rating + comment. Average ratings show on listing cards and the listing detail page.
